...
public class Javaparser_Main {
    public static void main(String[] args) {
        try {
            FileInputStream file = new FileInputStream("src/main/java/com/example/PatientVitals1.java");
        ...
        System.out.println("\nThe AST is below: \n");
           ...
           try {
            CompilationUnit cu = StaticJavaParser.parse(new File("src/main/java/com/example/PatientVitals1.java"));
